...
const PriceCardCreators = () => {
  return (
    <div className='bg-[#efebff] w-72  flex flex-col rounded-3xl items-center justify-center'>
      <h2 className='font-outfit font-bold text-[28px] p-5 text-center'>Creators</h2>
...
export default PriceCardCreators
